...
from src.prompts import STOCK_ANALYSIS_AGENT_PROMPT


def get_stock_analysis_agent(llm, async_db_engine):
    """
    Create and return a Stock Analysis Agent.

    Args:
        llm: The language model to use for the agent.

    Returns:
        Agent configured with STOCK_ANALYSIS_AGENT_PROMPT.
    """
    ...
    return create_agent(
        ...
        model=llm,
        system_prompt=STOCK_ANALYSIS_AGENT_PROMPT,
    )
